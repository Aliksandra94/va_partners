...
import static web365.destination.page.CyprusOrderConstants.*;
public class CyprusOrder extends Outgoing {

	public CyprusOrder(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	public CyprusOrder goToMessage() {
	...
	public CyprusOrder goToToOrder() {
