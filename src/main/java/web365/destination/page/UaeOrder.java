...
import static web365.destination.page.UaeOrderConstants.*;
public class UaeOrder extends Outgoing {

	public UaeOrder(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
