...
import static web365.destination.page.UkrainOrderConstants.*;
public class UkrainOrder extends Outgoing {

	public UkrainOrder(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	public UkrainOrder goToMessage() {
	...
	public UkrainOrder goToToOrder() {
