...
import static web365.destination.page.SingaporeOrderConstants. *;
public class SingaporeOrder extends Outgoing {

	public SingaporeOrder(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	public SingaporeOrder goToName() {
		moveToElement(name);
	...
	public SingaporeOrder goToPhone() {
		moveToElement(phone);
		return new SingaporeOrder (this.driver);
	}
	...
	public SingaporeOrder goToEmail() {
		moveToElement(email);
		return new SingaporeOrder(this.driver);
	}
	...
	public SingaporeOrder goToMessage() {
	...
	public SingaporeOrder goToToOrder() {
