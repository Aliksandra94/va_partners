...
import static web365.destination.page.MaldivesOrderConstants. *;
public class MaldivesOrder extends Outgoing {

	public MaldivesOrder(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	public MaldivesOrder goToPhone() {
		moveToElement(phone);
		return new MaldivesOrder (this.driver);
	}
	...
	public MaldivesOrder goToEmail() {
		moveToElement(email);
		return new MaldivesOrder(this.driver);
	}
	...
	public MaldivesOrder goToMessage() {
	...
	public MaldivesOrder goToToOrder() {
