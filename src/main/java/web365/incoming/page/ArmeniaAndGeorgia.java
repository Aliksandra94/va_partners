...
import static web365.incoming.page.ArmeniaAndGeorgiaConstants.*;

public class ArmeniaAndGeorgia extends IncomingTours {

	public ArmeniaAndGeorgia(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	public ArmeniaAndGeorgia goToName() {
		moveToElement(name);
	...
	public ArmeniaAndGeorgia goToPhone() {
		moveToElement(phone);
		return new ArmeniaAndGeorgia (this.driver);
	}
	...
	public ArmeniaAndGeorgia goToEmail() {
		moveToElement(email);
		return new ArmeniaAndGeorgia(this.driver);
	}
	...
	public ArmeniaAndGeorgia goToMessage() {
	...
	public ArmeniaAndGeorgia goToToOrder() {
